...
테크포임팩트 팀이 2024년 11월부터 현재까지 진행한 회고들을 정리한 웹 아카이브입니다. 팀의 성장 과정과 다양한 회고 방법론을 한눈에 볼 수 있습니다.

### 주요 기능

- 🗂️ **연도별 아카이브**: 2024-2026년 회고들을 연도별로 정리
- 🔍 **검색 기능**: 회고 제목, 날짜, 방법론으로 빠르게 찾기
- 🎲 **랜덤 선택**: 무작위로 회고 하나를 추천받기
- 📖 **방법론 매뉴얼**: 9가지 회고 방법론 상세 가이드
...
### 2026년 (진행 중)
12. **시동 점검** (2026.01) - 새해 첫 달 리뷰 & 2월 계획 · 5명 참석

**총 12회의 회고 | 3명 → 5명으로 팀 성장**

## 회고 방법론 매뉴얼

9가지 검증된 회고 방법론 가이드 제공:
...
9. **시동 점검** - 새해/전환기 첫 달 점검과 다음 달 설계
...
프로젝트 루트의 **`.work-request-template.md`** 파일을 참고하세요. 이 템플릿은 새 회고를 추가할 때 필요한 모든 단계를 체크리스트로 제공합니다.
...
# 1. 회고 파일 준비
# - method/[회고이름].md (매뉴얼)
# - retros/[회고이름].html (슬라이드/기록)

# 2. 템플릿 확인
cat .work-request-template.md
...
#  - 제목: [회고 이름]
#  - 영문명: [filename]
#  .work-request-template.md 보고 작업해줘!"
```

#### 주요 작업 단계

1. **상세 페이지 생성**: `retro-pages/[영문명].html`
2. **JavaScript 업데이트**: `js/main.js`의 `books` 객체에 추가
3. **메인 페이지 수정**: `index.html`에 카드 추가
4. **매뉴얼 페이지 수정**: `manuals.html`에 카드 추가
5. **커밋 & 푸시**: 템플릿의 커밋 메시지 예시 참고

자세한 내용은 `.work-request-template.md`를 참고하세요.

## 라이선스

© 2026 Kakao Impact - Team Tech for Impact
